  ...
  return (
    <div className='about'>
      ...
      <div className='vision_mision'>
        <div className='about_img'><img src="/img/about_img/vision.png" alt="" /></div>
        <div className='txt'>
          <div className='txt_mision'>
            <h2>Misión</h2>
            <div className='txt_img img_mision'>
          ...
          <div className='txt_vision'>
            <h2>Visión</h2>
            <div className='txt_img img_vision'>
      ...
      <div className='valores'>
        ...
        <div className='main_valores about_img'>
